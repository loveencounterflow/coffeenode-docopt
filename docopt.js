...
(function() {
  var AnyOptions, Argument, Command, Dict, DocoptExit, DocoptLanguageError, Either, OneOrMore, Option, Optional, Pattern, Required, TRM, TYPES, TokenStream, alert, atos, badge, debug, docopt, echo, formal_usage, help, info, log, parse_args, parse_atom, parse_doc_options, parse_expr, parse_long, parse_pattern, parse_seq, parse_shorts, print, printable_usage, report_extras, rpr, urge, warn, whisper,
