...
(function() {
  var AnyOptions, Argument, CND, Command, Dict, DocoptExit, DocoptLanguageError, Either, OneOrMore, Option, Optional, Pattern, Required, TokenStream, alert, atos, badge, debug, docopt, echo, formal_usage, help, info, log, parse_args, parse_atom, parse_doc_options, parse_expr, parse_long, parse_pattern, parse_seq, parse_shorts, print, printable_usage, report_extras, rpr, urge, warn, whisper,
  ...
  DocoptLanguageError = (function(_super) {
    ...
    function DocoptLanguageError(_at_message) {
  ...
  Argument = (function(_super) {
    ...
    function Argument(_at_argname, _at_value) {
      this.argname = _at_argname;
      this.value = _at_value != null ? _at_value : null;
    }
  ...
  Command = (function(_super) {
    ...
    function Command(_at_cmdname, _at_value) {
      this.cmdname = _at_cmdname;
      this.value = _at_value != null ? _at_value : false;
    }
  ...
  Option = (function(_super) {
    ...
    function Option(_at_short, _at_long, _at_argcount, _at_value) {
      this.short = _at_short != null ? _at_short : null;
      this.long = _at_long != null ? _at_long : null;
      this.argcount = _at_argcount != null ? _at_argcount : 0;
      this.value = _at_value != null ? _at_value : false;
    }
  ...
  TokenStream = (function(_super) {
    ...
    function TokenStream(source, _at_error) {
      var stream;
  ...
  report_extras = function(help, version, options, doc) {
  ...
  docopt = function(doc, Q) {
    var a, allowedargs, arg, argv, collected, formal_pattern, go_on, left, matched, name, opt, options, parameters, pot_arguments, pot_options, usage, version, _ref;
    if (Q == null) {
      Q = {};
    }
    ...
    argv = Q.argv === void 0 ? process.argv.slice(2) : Q.argv;
    name = Q.name === void 0 ? null : Q.name;
    help = Q.help === void 0 ? true : Q.help;
    version = Q.version === void 0 ? null : Q.version;
    ...
    if (go_on) {
      _ref = formal_pattern.fix().match(argv), matched = _ref[0], left = _ref[1], collected = _ref[2];
